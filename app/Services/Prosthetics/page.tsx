...
import { prosthetics } from '@/app/components/types';
const Prosthetics = () => {
	return (
		<section className='flex flex-col items-center w-full px-4 pt-28 pb-12 sm:px-12 md:pt-32 lg:px-20'>
			<div>
				...
				<p className='mb-8 text-sm text-dark tracking-wide md:text-xl md:mb-16 md:font-light'>
					...
					całkowite i szkieletowe. Nasz zespół dba o naprawy protez,
					podścielenie oraz oferuje różne rozwiązania protetyczne, zapewniając
